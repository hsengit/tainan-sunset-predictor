...
if weather_data and 'daily' in weather_data:
    ...
    if "☀️ 日落方位線" in layers_selected:
        try:
            ...
            deck_layers.append(pdk.Layer(
                "LineLayer",
                data=[{"start": [lon, lat], "end": [end_lon, end_lat]}],
    ...
    cloud_cfgs = {
        ...
        "🌥️ 中雲分布": {"val": details.get('mid'), "col": , "r": 2000}, # 修正：加上了  (橘色)
        "🔥 高雲分布": {"val": details.get('high'), "col": , "r": 1000}  # 修正：加上了  (紅橘色)
    }
