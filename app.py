...
if weather_data and 'daily' in weather_data:
    ...
    if "☀️ 日落方位線" in layers_selected:
        try:
            # 嘗試取得方位角，若無則預設 250 度
            hourly_azimuth = weather_data['hourly'].get('sun_azimuth',)
    ...
    cloud_cfgs = {
        ...
        "🔥 高雲分布": {"val": details.get('high', 0), "col": [255,0,0] ,    "r": 1000}  # 紅橘色
    }
